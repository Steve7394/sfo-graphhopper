...
public class NeighbourhoodOsmIdParser extends AdministrativeParser {
    public static final String KEY = AdministrativeLevel.NEIGHBOURHOOD.getName() + "_osm_id";
    private static final String ADMIN_TYPE = AdministrativeLevel.NEIGHBOURHOOD.getName();
    private final IntEncodedValue encoder;

    public NeighbourhoodOsmIdParser(EncodedValueLookup encodedValueLookup) {
