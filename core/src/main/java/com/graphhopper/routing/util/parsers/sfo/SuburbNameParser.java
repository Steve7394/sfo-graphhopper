...
public class SuburbNameParser extends AdministrativeParser {
    public static final String KEY = AdministrativeLevel.SUBURB.getName() + "_name";
    private static final String ADMIN_TYPE = AdministrativeLevel.SUBURB.getName();
    private final StringEncodedValue encoder;

    public SuburbNameParser(EncodedValueLookup encodedValueLookup) {
